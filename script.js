...
// Define a function to create the "add to cart" button
function createButton(item, cart) {
  ...
  button.addEventListener("click", () => {
    ...
    cartItem.textContent = `${item.name} - ${item.cost} pontos`;
    cart.appendChild(cartItem);
  });
  return button;
}

// Define a function to render a table based on the data
function renderTable(tableData, cart) {
  ...
  buttonHeader.textContent = "Carrinho";
...
// Render the attribute and expertise tables and add them to the DOM
const attributeTable = renderTable(data.attribute, document.getElementById("attributeCart"));
document.getElementById("attributeTable").appendChild(attributeTable);

const expertiseTable = renderTable(data.expertise, document.getElementById("expertiseCart"));
document.getElementById("expertiseTable").appendChild(expertiseTable);
